...
if __name__ == "__main__":
    ...
    setup(
        ...
        url="https://github.com/geng-haoran/haoran_ops",
        download_url="https://github.com/geng-haoran/haoran_ops/tags",
        description="Haoran Ops",
        long_description=Path("README.md").read_text(),
        packages=find_packages(exclude=("tests",)),
        package_data={"haoran_ops": ["*.dll", "*.so", "*.dylib"]},
        zip_safe=False,
        python_requires=">=3.9",
        install_requires=[
        ],
